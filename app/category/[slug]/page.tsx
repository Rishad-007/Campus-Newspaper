...
import { getArticlesByCategory, getCategoryMap } from "@/lib/mock-news";
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  const category = getCategoryMap().find((item) => item.slug === slug);

  if (!category) {
    notFound();
  }

  const stories = getArticlesByCategory(slug);
